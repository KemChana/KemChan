...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const isValidVietnameseWord = /^([a-zA-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠƯăâđêôơưàáảãạằắẵẳặầấậẩẫèéẻẹẽềếệểễìíỉịòóỏọõồốộổỗờớợởỡùúủụũừứựửữỳýỷỵỹ]{2,})\s+([a-zA-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠƯăâđêôơưàáảãạằắẵẳặầấậẩẫèéẻẹẽềếệểễìíỉịòóỏọõồốộổỗờớợởỡùúủụũừứựửữỳýỷỵỹ]{2,})$/i.test(newWord);
